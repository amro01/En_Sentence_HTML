...
export function buildGeneratedHTML(params) {
    ...
    return `
        ...
        <body>
            ...
            <footer style="text-align:center;margin:30px 0 10px;font-size:0.85em;color:#999;">
                <p>Generated by <a href="https://github.com/amro01/En_Sentence_HTML" target="_blank" style="color:#999;">En_Sentence_HTML</a> &copy; 2026</p>
            </footer>
        </body>
        </html>
    `;
